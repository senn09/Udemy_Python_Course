...
from flask import g, Flask, abort, render_template, redirect, url_for, flash, request
...
def register():
    ...
    if form.validate_on_submit():
        ...
        if not user_exists:
            ...
            flash('The email you have entered already exists')
